...
<body>
    <table id="example" class="table table-striped table-bordered" align="center" style="width: 100%">
        <thead>
            <tr>
            ...
            ?>
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <button id="<?php echo $id; ?>" class="btn btn-danger btn-sm hapus_data" onclick="return confirm('Apakah yakin akan menghapus data ini?')"><i class='fa fa-trash'></i> Hapus</button>
                        </td>
                    </tr>
                <?php } } else { ?>
